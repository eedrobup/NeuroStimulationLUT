...
@ray.remote
def pointElec_simulation(num_electrode, amp1, amp2, freq1, freq2, total_time, cell_type, plot_neuron_with_electrodes,plot_waveform):    
    ...
    for l in range(len(elec_location_ICMS)):
        ...
        if cell_type in [6,7,35,36]:
            ...
            break
        if num_electrode == 1:
            return np.array(soma_recording_filtered), np.array(t_filtered)
...
def main():
    ...
    parser.add_argument("--amp1", type=float, default=300, help="Amplitude of stimulation")
    parser.add_argument("--amp2", type=float, default=20, help="Amplitude of stimulation")
    parser.add_argument("--freq1", type=float, default=100, help="Frequency of stimulation")
    parser.add_argument("--freq2", type=float, default=5, help="Frequency of stimulation")
